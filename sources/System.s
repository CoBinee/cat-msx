...
1101$:
    outi
    jp      nz, 1101$
    ld      hl, (_patternNameLine + 0x0002)
    ld      b, #0x20
1102$:
    outi
    jp      nz, 1102$
    ld      hl, (_patternNameLine + 0x0004)
    ld      b, #0x20
1103$:
    outi
    jp      nz, 1103$
    ld      hl, (_patternNameLine + 0x0006)
    ld      b, #0x20
1104$:
    outi
    jp      nz, 1104$
    ld      hl, (_patternNameLine + 0x0008)
    ld      b, #0x20
1105$:
    outi
    jp      nz, 1105$
    ld      hl, (_patternNameLine + 0x000a)
    ld      b, #0x20
1106$:
    outi
    jp      nz, 1106$
    ld      hl, (_patternNameLine + 0x000c)
    ld      b, #0x20
1107$:
    outi
    jp      nz, 1107$
    ld      hl, (_patternNameLine + 0x000e)
    ld      b, #0x20
1108$:
    outi
    jp      nz, 1108$
    ld      hl, (_patternNameLine + 0x0010)
    ld      b, #0x20
1109$:
    outi
    jp      nz, 1109$
    ld      hl, (_patternNameLine + 0x0012)
    ld      b, #0x20
1110$:
    outi
    jp      nz, 1110$
    ld      hl, (_patternNameLine + 0x0014)
    ld      b, #0x20
1111$:
    outi
    jp      nz, 1111$
    ld      hl, (_patternNameLine + 0x0016)
    ld      b, #0x20
1112$:
    outi
    jp      nz, 1112$
    ld      hl, (_patternNameLine + 0x0018)
    ld      b, #0x20
1113$:
    outi
    jp      nz, 1113$
    ld      hl, (_patternNameLine + 0x001a)
    ld      b, #0x20
1114$:
    outi
    jp      nz, 1114$
    ld      hl, (_patternNameLine + 0x001c)
    ld      b, #0x20
1115$:
    outi
    jp      nz, 1115$
    ld      hl, (_patternNameLine + 0x001e)
    ld      b, #0x20
1116$:
    outi
    jp      nz, 1116$
    ld      hl, (_patternNameLine + 0x0020)
    ld      b, #0x20
1117$:
    outi
    jp      nz, 1117$
    ld      hl, (_patternNameLine + 0x0022)
    ld      b, #0x20
1118$:
    outi
    jp      nz, 1118$
    ld      hl, (_patternNameLine + 0x0024)
    ld      b, #0x20
1119$:
    outi
    jp      nz, 1119$
    ld      hl, (_patternNameLine + 0x0026)
    ld      b, #0x20
1120$:
    outi
    jp      nz, 1120$
    ld      hl, (_patternNameLine + 0x0028)
    ld      b, #0x20
1121$:
    outi
    jp      nz, 1121$
    ld      hl, (_patternNameLine + 0x002a)
    ld      b, #0x20
1122$:
    outi
    jp      nz, 1122$
    ld      hl, (_patternNameLine + 0x002c)
    ld      b, #0x20
1123$:
    outi
    jp      nz, 1123$
    ld      hl, (_patternNameLine + 0x002e)
    ld      b, #0x20
1124$:
    outi
    jp      nz, 1124$
...
_SystemClearPatternName::
    ...
    ; パターンネームのラインのクリア
    ld      hl, #(_patternNameLine + 0x0000)
    ld      de, #(_patternNameLine + 0x0001)
    ld      bc, #(0x0018 * 0x0002 - 0x0001)
    ld      (hl), #0x00
    ldir
